...
namespace Base.Core.nHandlers.nEmailHandler
{
    public class cEmailConfiguration : cCoreObject
    {
        ...
        public cEmailConfiguration(cApp _App, string _SmtpHost, int _SmtpPort, string _SmtpUsername, string _SmtpPassword, string _EmailDisplayName, bool _SmtpSslEnabled, string _MailFrom)
            : base(_App)
        {
            SmtpHost = _SmtpHost;
            SmtpPort = _SmtpPort;
