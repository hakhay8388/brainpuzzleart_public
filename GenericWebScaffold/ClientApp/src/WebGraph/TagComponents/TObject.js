...
var TObject = Class(
  ...
  CommandInterfaces.IForceUpdateCommandReceiver,
  {
    ...
    GetAppBreadcrumb: function (_BreakCrumbDict) {
      var __This = this;
      return (
        <Breadcrumbs aria-label="breadcrumb" separator={<NavigateNextIcon fontSize="small" />} style={{backgroundColor: DefaultTheme.palette.secondary.contrastText, padding: "10px"}}>
