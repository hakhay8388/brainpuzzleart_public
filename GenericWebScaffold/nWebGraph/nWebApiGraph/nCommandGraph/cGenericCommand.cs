...
namespace Core.GenericWebScaffold.nWebGraph.nWebApiGraph.nCommandGraph
{
    public class cGenericCommand : cBaseCommand
    {
                ...
                : base(_App, _WebGraph, _Command)
        {
            try
            {
                CommandDataClass = Type.GetType("Core.GenericWebScaffold.nWebGraph.nWebApiGraph.nCommandGraph.nCommands.n" + CommandID.Name + "Command.c" + CommandID.Name + "CommandData");
                CommandReceiverClass = Type.GetType("Core.GenericWebScaffold.nWebGraph.nWebApiGraph.nCommandGraph.nCommands.n" + CommandID.Name + "Command.I" + CommandID.Name + "Receiver");
            }
            catch (Exception _Ex)
            {
