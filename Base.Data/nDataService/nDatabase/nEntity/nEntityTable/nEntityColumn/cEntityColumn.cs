...
namespace Base.Data.nDataService.nDatabase.nEntity.nEntityTable.nEntityColumn
{
    public class cEntityColumn
    {
        ...
        public DBField DBField { get; private set; }

        public cEntityColumn(cEntityTable _EntityTable, string _Name, Type _PropertyType, DBField _DBField)
        {
