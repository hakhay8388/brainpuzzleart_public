...
namespace Core.BatchJobService.nDefaultValueTypes
{
    public class BatchJobIDs : cBaseConstType<BatchJobIDs>
    {
        ...
        public static BatchJobIDs OldNotificationDeleteJob = new BatchJobIDs(GetVariableName(() => OldNotificationDeleteJob), "OldNotificationDeleteJob", 3, 120000, EBatchJobState.Started, true, true, false, 3);
        public static BatchJobIDs MailSenderJob = new BatchJobIDs(GetVariableName(() => MailSenderJob), "MailSenderJob", 4, 15 * 1000, EBatchJobState.Started, false, true, false, 10);
        public static BatchJobIDs SitemapGenerateJob = new BatchJobIDs(GetVariableName(() => SitemapGenerateJob), "SitemapGenerateJob", 8, 6 * 60 * 60 * 1000, EBatchJobState.Started, true, true, false, 10);
        public static BatchJobIDs SessionTempClearJob = new BatchJobIDs(GetVariableName(() => SessionTempClearJob), "SessionTempClearJob", 2002, 600 * 1000, EBatchJobState.Started, true, true, false, 10);
        public static BatchJobIDs MssqlBackupJob = new BatchJobIDs(GetVariableName(() => MssqlBackupJob), "MssqlBackupJob", 2003, 24 * 60 * 60 * 1000, EBatchJobState.Started, true, true, false, 10);
