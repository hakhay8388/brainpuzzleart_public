...
namespace Data.GenericWebScaffold.nDataService.nDataManagers
{
    public class cUserDataManager : cBaseDataManager
    {
        ...
        public cUserDataManager(cGenericWebScaffoldDataServiceContext _CoreServiceContext, IDataServiceManager _DataServiceManager, IFileDateService _FileDataService, cRoleDataManager _RoleDataManager)
